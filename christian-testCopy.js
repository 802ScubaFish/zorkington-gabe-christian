...
const bedRoom = {
    name: 'bedRoom',
    desc: `You awaken in your bedroom, facing an SNES in the center of the room. There is a bed in the southwestern corner, to the southeast stands a tall potted plant. In the northwestern corner there is a PC on a stand set beside a small table. In the northeast is a set of stairs leading down.\nWhat would you like to do?`,
...
async function start() {
    ...
    if (input === `help`) {
        ...
        if (currentState === 'bedRoom') {
            ...
            if (noun.includes('bed') || noun.includes('bedroom')) {
                enterState('bedRoom');
                console.log(`The state is ${currentState}.`)
                return start();
            } 
