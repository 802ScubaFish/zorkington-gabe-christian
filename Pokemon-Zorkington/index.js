...
//pokemon class
class Pokemon {
    constructor(name, type, number, height, weight, description) {
        this.name = name,
            this.type = type,
            this.number = number,
            this.height = height,
...
const palletTown = {
    desc: 'You exit the building to Pallet Town.',
...
//I can play up to the point where you enter a nickname, but then I'm getting a type error.
